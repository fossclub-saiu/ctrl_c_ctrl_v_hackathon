...
### Level 2 & 3: Second and Third Year Students (Combined)

Level 2 and Level 3 submissions are evaluated together using the same criteria.

| Criteria                              | Weight | 1-3 (Poor)             | 4-6 (Average)        | 7-8 (Good)                 | 9-10 (Excellent)                        |
| ------------------------------------- | ------ | ---------------------- | -------------------- | -------------------------- | --------------------------------------- |
| **Functionality & Correctness** | 30%    | Core broken            | Partially working    | Stable, most features work | Fully functional, polished              |
| **Technical Depth**             | 30%    | Shallow implementation | Standard tech stack  | Advanced concepts used     | Sophisticated, well-architected         |
| **User Interface & Experience** | 20%    | Unusable or ugly       | Functional but rough | Clean and intuitive        | Polished, responsive, delightful        |
| **Video Presentation**          | 20%    | No demo, confusing     | Basic walkthrough    | Good technical explanation | Deep technical dive, clear architecture |
